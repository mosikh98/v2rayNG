...
object AppConfig {
    ...
    const val PREF_ARTWORK_OFFSET_X = "pref_artwork_offset_x"
    const val PREF_ARTWORK_OFFSET_Y = "pref_artwork_offset_y"
    const val PREF_ARTWORK_ZOOM = "pref_artwork_zoom"
    const val PREF_ARTWORK_OPACITY = "pref_artwork_opacity"
    const val PREF_ARTWORK_BLUR = "pref_artwork_blur"
    const val PREF_ARTWORK_BRIGHTNESS = "pref_artwork_brightness"
    const val PREF_ARTWORK_OVERLAY = "pref_artwork_overlay"
